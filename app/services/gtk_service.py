...
def resolve_gtk():
    prepend_env('Path', path.abspath(path.join(path.dirname(__file__), '../../gtk/bin')))

def unresolve_gtk():
    remove_env('Path', path.abspath(path.join(path.dirname(__file__), '../../gtk/bin')))
